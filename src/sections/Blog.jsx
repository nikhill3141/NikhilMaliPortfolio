...
export default function Blog({ sectionRef }) {
  ...
  return (
    <section
      ref={sectionRef}
      data-section="blogs"
      className="sleek-section"
    >
      {/* Header */}

      <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        <SectionHeading
          subHeading="Writing & Ideas"
          heading="Blogs"
        />
      </div>
      ...
      {isLoading && (
        <div className="mt-10 border-t border-[var(--border)]">
          <div className="border-b border-[var(--border)] py-8">
            <div className="h-5 w-32 animate-pulse rounded bg-[var(--muted)]/20" />

            <div className="mt-4 h-7 max-w-xl animate-pulse rounded bg-[var(--muted)]/20" />

            <div className="mt-3 h-4 max-w-2xl animate-pulse rounded bg-[var(--muted)]/20" />
          </div>

          <div className="border-b border-[var(--border)] py-8">
            <div className="h-5 max-w-lg animate-pulse rounded bg-[var(--muted)]/20" />
      ...
      {isError && (
        <div className="mt-10 border-t border-[var(--border)] py-8">
          ...
          <div className="grid md:grid-cols-[100px_1fr_auto] md:items-center">
            ...
            <div className="border-t border-[var(--border)] p-5 md:border-l md:border-t-0 md:p-8">
              ...
              >
                ...
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[var(--border)] transition-all duration-300 group-hover:bg-[var(--foreground)] group-hover:text-[var(--background)]">
